...
function NavLinks({ color }) {
    return (
        <>
            <Button variant="ghost" colorScheme="whiteAlpha" color={color} as={Link} to="/">
                Home
            </Button>

            <Menu>
                <MenuButton as={Button} variant="ghost" colorScheme="whiteAlpha" color={color}>
                    Academics
                </MenuButton>
            ...
            <Button variant="ghost" colorScheme="whiteAlpha" color={color} as={Link} to="/about">
                About
            </Button>
        </>
    )
    ...
    return (
        <>
            ...
            <Flex align="center" h={'46px'} zIndex={99} justify="space-between" p="0" px={2} bg="#192e59" color="#192e59" position={'sticky'} top={0}>
                ...
                <Modal m={4} onClose={closeNav} isOpen={isNavOpen} motionPreset='slideInLeft' >
                    <ModalOverlay />
