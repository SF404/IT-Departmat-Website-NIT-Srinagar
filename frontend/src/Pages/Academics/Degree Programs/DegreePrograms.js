...
import { VStack, Heading, Center, Box, Tabs, TabList, Tab, TabPanels, TabPanel, Divider } from '@chakra-ui/react';
  ...
  render() {
    ...
    return (
      <div className='degback'>
        ...
        <Center p={4}>
          <Box width={{ base: '100%', md: '80%' }} bg={'white'} boxShadow={'0 0 12px rgba(0,0,0,0.05)'} borderRadius={'1em'} p={2}>
            <Tabs align='center' variant='soft-rounded' colorScheme='green'>
              <TabList my={'1em'}>
                <Tab w={'150px'}>B-TECH</Tab>
                <Tab w={'150px'}>PHD</Tab>
              </TabList>
              <Divider />
              <TabPanels className='family-1'>
                <TabPanel>
                ...
                <TabPanel>
                  <div className='my-div'>
                    ...
                    <Divider my={4} />
                    <h2 className=' dghead my-div'>Admission</h2>
